...
import { User, UsersService } from 'src/main/system/users/users.service';
...
export class AuthService {
  ...
  get user(): User {
    if (!this._user) {
      ...
      this._user = Object.assign({permissions:{actions:[],menus:[]},token:''}, session ? session : local);
  ...
  set user(value: User) {
    this._user = Object.assign(this._user ? this._user : {permissions:{actions:[],menus:[]},token:''}, value);
    this.settingService.setSession(this.key, this._user);
  }
  ...
  constructor(public httpService: HttpService,private userservice:UsersService, public settingService: SettingService) {
