...
@Component({
  selector: 'app-samplebrowsetask',
  templateUrl: './samplebrowsetask.component.html',
  styleUrls: ['./samplebrowsetask.component.scss']
})
export class SamplebrowsetaskComponent extends PageBase implements OnInit {
